    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="companyName"
                              title="${message(code: 'user.companyName.label', default: 'Company Name')}"/>

            <g:sortableColumn property="emailAddress"
                              title="${message(code: 'user.emailAddress.label', default: 'Email Address')}"/>
        ...
        <g:each in="${userInstanceList}" status="i" var="userInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${userInstance.id}">${fieldValue(bean: userInstance, field: "companyName")}</g:link></td>
